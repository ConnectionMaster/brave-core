...
class ADS_EXPORT AdsClient {
 public:
  ...
  //   ├──catalog-schema.json
  //
  // |catalog-schema.json| are JSON schemas which specify the JSON-based format
  // to define the structure of the JSON data for validation, documentation, and
  // interaction control. It provides the contract for the JSON data and how
  // that data can be modified
