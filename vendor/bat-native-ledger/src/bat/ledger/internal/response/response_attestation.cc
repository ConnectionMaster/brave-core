...
// Request Url: POST /v1/attestations/safetynet (Android)
...
// Request Url: POST /v1/captchas (Desktop)
//
// Response Format:
// {
//   "hint": "circle",
...
// Request Url: GET /v1/captchas/{captcha_id}.png
//
// Response Format:
// {PNG data}
...
// Request Url: PUT /v1/captchas/{captcha_id} (Desktop)
